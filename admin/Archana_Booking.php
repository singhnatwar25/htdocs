...
<body>
    ...
    <header>
        ...
        <div class="header bg-light py-4">
            <div class="container">
                <h1 class="text-success text-center">Hotel Archana</h1>
            </div>
        </div>
...
$dateQuery = "SELECT DISTINCT DATE(bookingDate) AS booking_date FROM booking";
...
?>
    ...
    <div class="container-fluid ">
        ...
        while ($dateRow = $dateResult->fetch_assoc()) {
            ...
            $sql = "SELECT * FROM booking WHERE DATE(bookingDate) = '$bookingDate' AND hotel_id = '2'";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='text-success'>" . $row["Confirm"] . "</td>";
                    echo "<td>
                                <a href='update_booking.php?id=" . $row["id"] . "' class='btn btn-primary btn-sm'>Edit</a>
                                <a href='delete-booking.php?id=" . $row["id"] . "' class='btn btn-danger btn-sm'>Delete</a>
                              </td>";
                    echo "</tr>";
                }
